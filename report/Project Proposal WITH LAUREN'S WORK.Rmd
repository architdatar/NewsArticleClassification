...
knitr::include_graphics("images for proposal/positive boxplots.png")
```
...
knitr::include_graphics("images for proposal/negative boxplots.png")
```
...
```{r echo=FALSE, fig.cap="Principal Component Scores", out.width = '70%', fig.align='center'}
knitr::include_graphics("images for proposal/pca.png")
```
