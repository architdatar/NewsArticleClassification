...
dev.new()
par(mfrow = c(1,3), cex=0.8, mar=c(1,1,0.5,0.5) )
...
From the PCA, we can see that the variances are almost equally distributed among all principal components, and at least the first 50 components cannot be ignored. 
It is hard to draw conclusions about what each of the components represent. 
