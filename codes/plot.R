...
boxplot(coronavirus ~ related, main = "coronavirus", data = ready_to_use_NoOriginalData)
boxplot(respons ~ related, main = "respons", data = ready_to_use_NoOriginalData)
boxplot(fauci ~ related, main = "fauci", data = ready_to_use_NoOriginalData)
boxplot(check ~ related, main = "check", data = ready_to_use_NoOriginalData)
...
boxplot(brief ~ related, main = "brief", data = ready_to_use_NoOriginalData)
boxplot(fact ~ related, main = "fact", data = ready_to_use_NoOriginalData)
boxplot(dr ~ related, main = "dr", data = ready_to_use_NoOriginalData)
...
boxplot(quarantin ~ related, main = "quarantin ", data = ready_to_use_NoOriginalData)
boxplot(close ~ related, main = "close ", data = ready_to_use_NoOriginalData)
...
par(mfrow = c(1,5))
boxplot(senat ~ related, main = "senate ", data = ready_to_use_NoOriginalData)
boxplot(covid ~ related, main = "covid ", data = ready_to_use_NoOriginalData)
boxplot(around ~ related, main = "around ", data = ready_to_use_NoOriginalData)
boxplot(cuomo ~ related, main = "cuomo ", data = ready_to_use_NoOriginalData)
boxplot(south ~ related, main = "south ", data = ready_to_use_NoOriginalData)
